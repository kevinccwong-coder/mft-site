      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-5 text-base leading-relaxed text-secondary/75 sm:text-lg">
            ...
            <br className="hidden sm:inline" />
            提供專業、保密、貼心的<a href="https://www.chp.gov.hk/mhi/index_en.html" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2 hover:text-primary-dark">心理輔導服務</a>。
          </p>
        </div>
