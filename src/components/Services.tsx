...
const services = [
  {
    icon: Heart,
    title: "婚姻輔導及家庭治療",
    desc: "處理夫妻衝突、家庭危機、婚外情修復、親子關係緊張。我們幫助家庭成員重新聽見彼此的聲音，亦擅長處理家庭暴力創傷、家人長期隱蔽在家（隱蔽青年／雙失）及三代之間的矛盾張力（婆媳衝突／隔代教養）。",
    highlights: [
      "夫妻溝通修復",
      "婚外情創傷處理",
      "家庭暴力／家暴創傷輔導",
  ...
  },
  {
    icon: Brain,
    title: "情緒與壓力輔導",
    desc: "焦慮、驚恐症、抑鬱、情緒失控、長期壓力、哀傷失落。在安全的空間裡，讓情緒被聽見、被理解。我們幫助你學習正確表達負面情緒，應對職場過勞（burnout／爆煲），重新找回內在的平靜。",
    highlights: [
      "焦慮症／驚恐症",
      "抑鬱情緒處理",
      "壓力管理及 burnout（職場過勞）",
